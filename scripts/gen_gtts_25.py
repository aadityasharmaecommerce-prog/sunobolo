#!/usr/bin/env python3
"""
Regenerate 25 free trial sentences using gTTS (Google Translate TTS).
Produces natural, human-like voice for both English and Hindi.
"""
...
def main():
    ...
    for i, sentence in enumerate(SENTENCES):
        ...
        try:
            # Use 'com' domain for best quality Google TTS
            tts_en = gTTS(text=sentence["english"], lang="en", slow=False, tld="com")
        ...
        try:
            tts_hi = gTTS(text=sentence["hindi"], lang="hi", slow=False, tld="com")
