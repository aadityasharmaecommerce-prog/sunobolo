#!/usr/bin/env python3
"""
Generate 25 free trial sentences — Viraj-style natural male voice.
Voice: hi-IN-MadhurNeural (Indian Male, Friendly, Positive)
Rate: Normal speed (no slowdown — energetic, warm feel)
Same voice for English + Hindi — consistent teacher-like tone.
"""
...
RATE = "+0%"  # Normal speed — energetic, not slow
...
def main():
    ...
    print(f"\nDone! {success}/{total} EN + {total} HI — Viraj-style male voice")
