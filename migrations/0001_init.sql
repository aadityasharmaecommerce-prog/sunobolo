...
-- Entities: users, user_profiles, courses, course_categories, lessons, sentences,
--           packages, package_courses, subscriptions, user_progress, lesson_progress,
--           daily_activity, favorites, admin_users, analytics_events
